  ...
  return (
    ...
    <div className="login">
      <div className='login-main'>
        <Input className="login-input" placeholder="用户名" prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />} onChange={e => setUser(e.target.value)} />
      ...
      <video className="login-video" loop autoPlay muted>
        ...
        <source src={require(`@/assets/video/bird_pc.mov`)} type="video/ogg"></source>
